...
{
	public class EfQuestionnarieQuestionDataAccess:EfGenericDataAccess<QuestionnarieQuestion>,IQuestionnarieQuestionDataAccess
	{
        public EfQuestionnarieQuestionDataAccess(PdrAutomateContext context) : base(context)
        {
